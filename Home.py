...
html_7 = """
<div style="background-color:#BAE7FF;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black;color:black;justify-content:center;">
...
if st.button("แสดงการจินตทัศน์ข้อมูล"):
   ...
   st.button("ไม่แสดงข้อมูล")
    ...
    html_8 = """
<div style="background-color:#A3E0FF;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black;color:black;justify-content:center;">
